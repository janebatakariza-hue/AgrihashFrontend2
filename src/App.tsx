...
.hero{position:relative;min-height:580px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:80px 28px 60px;overflow:hidden}
...
.foot-box{width:26px;height:26px;background:linear-gradient(135deg,#4ab734,#1a5210);border-radius:7px;display:flex;align-items:center;justify-content:center;animation:logoMorph 4s 1s ease-in-out infinite}
.foot-name{font-family:'Cormorant Garamond',serif;font-size:16px;color:#5a8050}
.foot-sub{font-size:11px;color:#1e3418}
`;

const TICKER_ITEMS = [
  { label: "Organic Tomatoes", val: "0.68 USDC/kg" },
  { label: "Premium Coffee", val: "3.12 USDC/kg" },
  { label: "Maize N.Province", val: "0.44 USDC/kg" },
  { label: "Avocados Hass", val: "1.87 USDC/kg" },
  { label: "Sweet Potatoes", val: "0.29 USDC/kg" },
  { label: "Green Beans", val: "0.55 USDC/kg" },
  { label: "BATCH-0x4A2F", val: "IN TRANSIT" },
  { label: "BATCH-0x7B9E", val: "DELIVERED" },
  { label: "AGT Token", val: "↑ +2.4%" },
];
        ...
        <div className={"app-root" + (appVisible ? " visible" : "")}>
          <nav>
            <div className="logo" onClick={() => showView("home")}>
              ...
              <span className="nav-badge">BASE L2</span>
            </div>
            ...
            <div className="navr">
              <div className="wpill">
                ...
                <Icon.Wallet
                  ...
                  style={{ color: "#5a7a50" }}
                />
                <span className="wa">0x4A2...F8c</span>
                <span className="wb">{agtVal} AGT</span>
              </div>
              <button
                className="btnP"
              ...
              <button className="btnO" onClick={signOut}>
                ...
                (it, i) => (
                  <div key={i} className="titem">
                    <Icon.Package
                      ...
                      style={{ color: "#4ab734" }}
                    />
                    {it.label} <span className="titem-val">{it.val}</span>
                    <div className="titem-dot" />
                  </div>
                ),
              )}
            </div>
          ...
          <footer>
            <div className="foot-logo">
              <div className="foot-box">
                <Icon.Leaf width="14" height="14" stroke="#fff" />
              </div>
              <span className="foot-name">AgriChain</span>
            </div>
            <p className="foot-sub">
              Built on Base L2 · Secured by Ethereum · Powered by the community
            </p>
          </footer>
        </div>
      )}
